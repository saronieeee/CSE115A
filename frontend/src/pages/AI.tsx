...
const mockItems: ClothingItem[] = [
  ...
  },
  {
    id: "b1",
    title: "Blue Jeans",
    image: "https://m.media-amazon.com/images/I/715K4AhGLZS._AC_UY1000_.jpg",
    tag: "Pants",
  },
  // Outerwear items
  {
  ...
  // Formal items
  {
    ...
    title: "Black Dress",
    image:
      "https://vader-prod.s3.amazonaws.com/1651851897-best-babydoll-dresses-matteau-dress-1651851878.png",
    tag: "Dress",
  },
  {
    id: "t5",
...
export const AI: React.FC = () => {
  ...
  async function handleGenerate() {
    ...
    try {
      const bodyBase64 = await fileToBase64(photoFile);

      const clothingImageUrls = selectedItems
        .map((i) => i.image)
        .filter(Boolean) as string[];

      const res = await fetch("http://localhost:3001/api/outfits/generate", {
        method: "POST",
      ...
      setGeneratedImage(data.image || data.result || null);
    } catch (err) {
        ...
        <div className="styling-container">
          ...
          <div style={{ marginTop: 24 }}>
            ...
            <button
              ...
              disabled={!photoFile || selectedItems.length === 0 || loading}
            >
